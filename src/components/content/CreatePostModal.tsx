...
export function CreatePostModal({
  ...
  function reset() {
    setType("post"); setTitle(""); setBody(""); setMediaUrl("");
    ...
    >
      {success ? (
        ...
        <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4 max-h-[70vh] overflow-y-auto pr-1">
          ...
          {/* URL de mídia */}
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="cp-media" className="text-sm font-medium text-ink dark:text-white">
              URL de mídia <span className="text-xs font-normal text-stone">(opcional)</span>
            </Label>
            <Input
              id="cp-media"
              type="url"
